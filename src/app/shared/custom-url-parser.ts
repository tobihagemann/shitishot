import { PRIMARY_OUTLET, UrlSegment, UrlSegmentGroup } from '@angular/router';

// ---
// It's basically copy & paste from https://github.com/angular/angular/blob/master/packages/router/src/url_tree.ts.
// The only difference is that `parseFragment()` of `CustomUrlParser` does not call `decodeURIComponent()` on the fragment.
// ---
